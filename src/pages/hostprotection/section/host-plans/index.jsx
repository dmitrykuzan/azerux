...
import { Container, Image, LocationDropDown, Typography } from '@components/ui';

import { Swiper, SwiperSlide } from 'swiper/react';
import { Navigation, Pagination } from 'swiper/modules';

import { HOST_PLANS, HOST_PLANS_ANNUALY, HOST_PLANS_QUARTERLY, HOST_PLANS_SEMI } from '@utils';
...
export const HostPlans = (props) => {
  ...
  return (
    <section className="plans plans--host" id="plans">
      {isMounted && (
      ...
      <Container>
        <div className="plans__wrapper">
          <div className="plans__top stack column">
            ...
            <Typography className="plans__subtitle" weight="300" tag="p" center>
              {t.subtitle.saveup}
            </Typography>
          ...
          {activeTab === 'monthly' && (
            <div className="plans__content stack">
              ...
              >
                {HOST_PLANS.map(({ id, tariff, price, list, featuresTitle, featuresList, label }) => (
                  <SwiperSlide key={id}>
                    <PlanCard
                      tariff={tariff}
                      price={price}
          ...
          {activeTab === 'quarterly' && (
            <div className="plans__content stack">
              ...
              >
                {HOST_PLANS_QUARTERLY.map(({ id, tariff, price, list, featuresTitle, featuresList, label }) => (
                  <SwiperSlide key={id}>
                    <PlanCard
                      tariff={tariff}
                      price={price}
          ...
          {activeTab === 'semiannualy' && (
            <div className="plans__content stack">
              ...
              >
                {HOST_PLANS_SEMI.map(({ id, tariff, price, list, featuresTitle, featuresList, label }) => (
                  <SwiperSlide key={id}>
                    <PlanCard
                      tariff={tariff}
                      price={price}
          ...
          {activeTab === 'annualy' && (
            <div className="plans__content stack">
              ...
              >
                {HOST_PLANS_ANNUALY.map(({ id, tariff, price, list, featuresTitle, featuresList, label }) => (
                  <SwiperSlide key={id}>
                    <PlanCard
                      tariff={tariff}
                      price={price}
